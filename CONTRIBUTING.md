...
Welcome to `polygraph` contributor's guide.
...
If you experience bugs or general issues with `polygraph`, please have a look
...
You can help improve `polygraph` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`polygraph` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `polygraph`'s files. While this mechanism can
...
```
conda create -n polygraph python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/polygraph.git
   cd polygraph
   ```
...
5. Install [pre-commit]:
   ...
   `polygraph` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/polygraph
[issue tracker]: https://github.com/<USERNAME>/polygraph/issues
